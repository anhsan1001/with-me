const PostContent = () => {
  return (
    <div className="text-white px-10 card-post">
      <div className=" flex flex-row justify-between">
        <div className="flex flex-row justify-center items-center gap-2">
          ...
          <div className="">
            ...
            <div className="text-slate-500 text-xs">1 phút</div>
          </div>
        </div>
        <button className="">
          <svg
      ...
      <div className="">
        <div className="pb-2">
          ...
          culpa exercitationem, expedita ut explicabo cum minus corporis id
          incidunt laborum non odio optio quod, consequuntur, reprehenderit
          debitis obcaecati nostrum.
        </div>
        <img
          className="rounded-md border-solid border-[1px] border-slate-800"
          src="https://cdn.vjshop.vn/tin-tuc/cach-chup-anh-phong-canh/cach-chup-anh-phong-canh-dep-15.jpg"
          alt=""
        />
      </div>
      <div className="flex flex-row gap-5 justify-around py-4 ">
        <button className=" btn-post hover:text-[#C70C34]">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            fill="none"
            viewBox="0 0 24 24"
        ...
        <button className=" btn-post hover:text-[#04D435] ">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            fill="none"
            viewBox="0 0 24 24"
        ...
        <button className="btn-post hover:text-[#0BABDB]">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            fill="none"
            viewBox="0 0 24 24"
